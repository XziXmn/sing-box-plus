...
稳定版默认下载 GitHub Release 中的 `code.tar.gz`：
...
主菜单会展示当前普通代理配置和链式转发配置，并提供添加、修改、删除、更新、链式转发等入口。
...
```
sing-box-plus script v0.1.6 personal modified version
